...
Even akhono ami ay same vabe e arch install kori manually pari na. Tobe issa ace Insa&rsquo;allah aste aste sekhar jate sob jinis gula bujhte pari j kivabe ki kaj kore. To Akhn as a main os ami [Arch Linux](https://archlinux.org/) abong [DE](https://wiki.archlinux.org/title/Desktop_environment) abong [WM](https://wiki.archlinux.org/title/Window_manager) hisabe Emacs x Window Manager mane [EXMW](https://github.com/emacs-exwm/exwm) use korci.


## Conclusion

So ayta cilo akta short introduction j ami ki ki use kortaci mainly r kivabe full system setup kora jai oibepare poroborti te kotha hobe insa&rsquo;allah.
